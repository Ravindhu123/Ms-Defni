...
Asena.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
    if (therikick_var == 'true' && message.jid !== '905511384572-1616356915@g.us') {
        let regex1 = new RegExp('පකයා')
        let regex2 = new RegExp('හුත්තා')
        let regex3 = new RegExp('පොන්නයා')
        let regex4 = new RegExp('sex')
        let regex5 = new RegExp('කැරිය')
        let regex6 = new RegExp('pakaya')
        let regex7 = new RegExp('hutto')
        let regex8 = new RegExp('ammata')
        let regex9 = new RegExp('ponnaya')
        let regex10 = new RegExp('අම්මට')
